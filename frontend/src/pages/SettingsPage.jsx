...
import { Building, Upload, Receipt, Globe, FileText, Hash, Save } from 'lucide-react';
    ...
    (async () => {
      try {
        ...
        if (profileRes.profile) {
          ...
          setBusiness({ name: p.businessName || '', email: p.contactEmail || '', phone: p.contactPhone || '', address: p.businessAddress || '', website: p.website || '' });
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 rounded-2xl bg-primary-50 flex items-center justify-center border-2 border-dashed border-primary-200 overflow-hidden">
                {logoUrl ? <img src={logoUrl} alt="Logo" className="w-full h-full object-cover" /> : <Upload className="w-6 h-6 text-primary-400" />}
              </div>
              <div>
                <label className="cursor-pointer">
                  <Button variant="outline" size="sm" icon={Upload} as="span">Upload Logo</Button>
