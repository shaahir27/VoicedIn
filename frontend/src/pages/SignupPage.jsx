    ...
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-600 to-primary-500 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <p className="text-primary-100 text-lg leading-relaxed max-w-md">
            Join thousands of freelancers who create invoices in seconds. Premium starts at just ₹99/month.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <button onClick={handleGoogleSignup} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
